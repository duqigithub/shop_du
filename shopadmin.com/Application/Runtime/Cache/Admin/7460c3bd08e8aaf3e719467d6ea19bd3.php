    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($rows)): foreach($rows as $key=>$row): ?><tr>
                    ...
                    <td align="center"><img src="/Public/images/<?php if($row["is_on_sale"] == 1): ?>yes.gif<?php else: ?>no.gif<?php endif; ?>"/></td>
                    <td align="center"><img src="/Public/images/<?php if($row["is_best"]): ?>yes.gif<?php else: ?>no.gif<?php endif; ?>"/></td>
                    <td align="center"><img src="/Public/images/<?php if($row["is_new"]): ?>yes.gif<?php else: ?>no.gif<?php endif; ?>"/></td>
                    <td align="center"><img src="/Public/images/<?php if($row["is_hot"]): ?>yes.gif<?php else: ?>no.gif<?php endif; ?>"/></td>
                    ...
                    <td align="center">
                        ...
                        <a href="<?php echo U('remove',['id'=>$row['id']]);?>" onclick="" title="删除"><img src="/Public/images/icon_trash.gif" width="16" height="16" border="0" /></a></td>
